...
namespace GoodmotionCookieConsent\Dependencies\PressWind;

use GoodmotionCookieConsent\Dependencies\PressWind\Base\CSSAsset;
use GoodmotionCookieConsent\Dependencies\PressWind\Base\JSAsset;
...
class PWVite
{
    ...
    'front', bool $is_ts = false, string|bool $plugin_path = false, string $slug = 'presswind-script', $is_https = true, $main_file = 'main')
    {
        $this->port = $port;
        $this->path = $path;
        $this->is_ts = $is_ts;
    ...
    private function getPath(): string
    {
        ...
        return ($this->is_plugin ? PWHelpers::cleanPath($this->get_relative_path_from(false), false) :
