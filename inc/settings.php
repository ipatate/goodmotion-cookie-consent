 ...
 */
function get_consent_modal(): array
{
    $modal = [
        'title' => __('We use cookies!', 'goodmotion-cookie-consent'),
        'description' => __('Hi, this website uses essential cookies to ensure its proper operation and tracking cookies to understand how you interact with it.', 'goodmotion-cookie-consent'),
        'primary_btn' => [
 ...
 */
function get_settings_modal(): array
{
    $values = [
        'title' => __(
            '🍪 Cookies settings',
 ...
 */
function set_var_settings_cookies(): void
{
    $var =
      [
